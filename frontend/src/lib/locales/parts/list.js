...
export default {
  en: {
    ...
    "list.moveToFolder": "Move to folder",
    "list.clearSelection": "Clear selection",
    "list.selectionActions": "{n} selected",
  ...
  cs: {
    ...
    "list.moveToFolder": "Přesunout do složky",
    "list.clearSelection": "Zrušit výběr",
    "list.selectionActions": "{n} vybráno",
    ...
    "list.catUpdates": "Upozornění",
    "list.catPromotions": "Promoakce",
    ...
    "list.bulkFlagged": "{n} označeno příznakem",
