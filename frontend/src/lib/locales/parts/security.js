...
export default {
  en: {
    ...
    "security.startupKeyring": "On this device the key is stored in the Windows Credential Manager, guarded by your OS login, rather than a plain file.",
  ...
  cs: {
    ...
    "security.screenerToggle": "Filtr odesílatelů (noví odesílatelé)",
    "security.screenerHint": "Pošta od lidí, se kterými jste si nikdy nedopisovali, se místo do schránky uloží do „Filtru odesílatelů“ - každého nového odesílatele jednou schválíte nebo zablokujete (ve stylu Hey).",
    ...
    "security.startupKeyring": "Na tomto zařízení je klíč uložen ve Správci přihlašovacích údajů Windows, chráněný přihlášením do systému, nikoli v prostém souboru.",
